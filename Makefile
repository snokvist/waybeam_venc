...
STAR6E_ONLY_SRC := src/star6e_output.c src/star6e_audio.c src/star6e_hevc_rtp.c src/star6e_video.c src/star6e_pipeline.c src/star6e_controls.c src/star6e_runtime.c src/star6e_cus3a.c src/star6e_iq.c src/star6e_jpeg.c src/star6e_eis.c src/star6e_eis_eptz.c
...
SOC_CFLAGS := -mfpu=neon-vfpv4 -mfloat-abi=hard -ftree-vectorize \
              -Ivendor/sigmastar-eis/include
SOC_DEFS := -DPLATFORM_STAR6E -DHAVE_BACKEND_STAR6E=1
SOC_LDFLAGS := -Lvendor/sigmastar-eis/lib
SOC_LIBS := -leptz -lm
BASE_LIBS := -Wl,--start-group -lpthread -ldl -lrt -Wl,--end-group
BUILD_TESTS := 1
