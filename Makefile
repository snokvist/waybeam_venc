...
STAR6E_ONLY_SRC := src/star6e_output.c src/star6e_audio.c src/star6e_hevc_rtp.c src/star6e_video.c src/star6e_pipeline.c src/star6e_controls.c src/star6e_runtime.c src/star6e_cus3a.c src/star6e_recorder.c src/star6e_ts_recorder.c src/ts_mux.c src/imu_bmi270.c src/eis.c src/eis_legacy.c src/eis_gyroglide.c
LIB_RUNPATH ?= /usr/lib
...
$(TEST_EIS_GG): tests/test_eis_gyroglide.c src/eis_gyroglide.c src/eis.c src/eis_legacy.c include/eis.h include/eis_gyroglide.h include/eis_legacy.h include/eis_ring.h
	$(HOST_CC) $(HOST_CFLAGS) -DEIS_GYROGLIDE_TEST tests/test_eis_gyroglide.c src/eis_gyroglide.c src/eis.c src/eis_legacy.c -lpthread -lm -o $@
