...
```json
{
  ...
  "data": {
    "config": {
      ...
      "video0": { "rcMode": "cbr", "fps": 90, "size": "auto", "bitrate": 8192, "gopSize": 1.0, "qpDelta": 0, "frameLost": true, "sceneThreshold": 0, "sceneHoldoff": 2, "resilience": "off", "zoomPct": 0.0, "zoomX": 0.5, "zoomY": 0.5, "stab": "off" },
...
```json
{
  ...
  "data": {
    "fields": {
      ...
      "video0.stab": { "mutability": "restart_required", "supported": true },
