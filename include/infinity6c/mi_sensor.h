...
#define SENSOR_VERSION_STR(major_version, sub_version)                                                                 \
    (                                                                                                                  \
        {                                                                                                              \
            char *tmp =                                                                                                \
                sub_version / 100  ? "mi_sensor_version_" MACRO_TO_STR(major_version) "." MACRO_TO_STR(sub_version)    \
                : sub_version / 10 ? "mi_sensor_version_" MACRO_TO_STR(major_version) ".0" MACRO_TO_STR(sub_version)   \
                                   : "mi_sensor_version_" MACRO_TO_STR(major_version) ".00" MACRO_TO_STR(sub_version); \
            tmp;                                                                                                       \
        })
...
extern "C"
{
    ...
    MI_S32 MI_SNR_CustFunction(MI_SNR_PADID ePADId, MI_U32 u32CmdId, MI_U32 u32DataSize, void *pCustData,
