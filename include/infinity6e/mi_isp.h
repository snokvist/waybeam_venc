...
#define MI_ISP_API_ISPMID_NOT_SUPPORT   (5)
    ...
    MI_S32 MI_ISP_CUS3A_SetAFYParam(MI_U32 Channel, CusAFYParam_t *data);
    MI_S32 MI_ISP_CUS3A_GetAFYParam(MI_U32 Channel, CusAFYParam_t *data);
    MI_S32 MI_ISP_CUS3A_SetAFSource(MI_U32 Channel, CusAFSource_e *data);
    MI_S32 MI_ISP_CUS3A_GetAFSource(MI_U32 Channel, CusAFSource_e *data);
