...
extern "C"
{
    ...
    MI_S32 MI_ISP_AWB_SetSpecialCase(MI_U32 Channel, MI_ISP_AWB_SPECIALCASE_PARAM_t *data);
    MI_S32 MI_ISP_AWB_GetSpecialCase(MI_U32 Channel, MI_ISP_AWB_SPECIALCASE_PARAM_t *data);
    MI_S32 MI_ISP_AWB_QuerySpecialCaseInfo(MI_U32 Channel, MI_ISP_AWB_SPECIALCASE_INFO_t *data);
    /************************************* AWB API END   *************************************/
