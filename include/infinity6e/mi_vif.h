...
MI_S32 MI_VIF_SetDevMclk(MI_VIF_DEV u32VifDev, MI_VIF_MclkSource_e eMclk);
MI_S32 MI_VIF_GetDevMclk(MI_VIF_DEV u32VifDev, MI_VIF_MclkSource_e *peMclk);

MI_S32 MI_VIF_EnableDev(MI_VIF_DEV u32VifDev);
MI_S32 MI_VIF_DisableDev(MI_VIF_DEV u32VifDev);

MI_S32 MI_VIF_SetChnAttr(MI_VIF_DEV u32VifDev, MI_VIF_CHN u32VifChn, MI_VIF_ChnAttr_t *pstChnAttr);
MI_S32 MI_VIF_GetChnAttr(MI_VIF_DEV u32VifDev, MI_VIF_CHN u32VifChn, MI_VIF_ChnAttr_t *pstChnAttr);
