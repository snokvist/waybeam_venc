...
typedef enum __attribute__ ((aligned (4)))
{
    SS_AWB_SPECIAL_WEIGHTCTRL  = 0,
    SS_AWB_SPECIAL_PREFER_CT   = 1,
    SS_AWB_SPECIAL_PREFER_GAIN = 2
} MI_ISP_AWB_SPECIAL_MODE_TYPE_e;

typedef struct MI_ISP_AWB_SPECIAL_CASE_s
{
    MI_U8  uGroup1_ZoneNum;
    MI_U16 u2Group1_CenterX[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U16 u2Group1_CenterY[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U8  uGroup1_Radius[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U8  uGroup1_CntLutNodeNum;
    MI_S32 s4Group1_CntLutX[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_S32 s4Group1_CntLutY[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_U8  uGroup2_ZoneNum;
    MI_U16 u2Group2_CenterX[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U16 u2Group2_CenterY[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U8  uGroup2_Radius[MI_ISP_AWB_SPECIAL_ZONE_NUM];
    MI_U8  uGroup2_CntLutNodeNum;
    MI_S32 s4Group2_CntLutX[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_S32 s4Group2_CntLutY[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_U8  uBvLutNodeNum;
    MI_S32 s4BvLutX[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_S32 s4BvLutY[MI_ISP_AWB_SPECIAL_NODE_NUM];
    MI_ISP_AWB_SPECIAL_MODE_TYPE_e eMode;
    MI_U16 u2Weight[MI_ISP_AWB_CT_TBL_NUM];
    MI_U32 u4PreferCT;
    MI_U16 u2PreferRgain;
    MI_U16 u2PreferBgain;
} MI_ISP_AWB_SPECIAL_CASE_t;

typedef struct MI_ISP_AWB_SPECIALCASE_PARAM_s
{
    MI_U32 u4CaseNum;
    MI_ISP_AWB_SPECIAL_CASE_t  stCase[MI_ISP_AWB_SPECIAL_CASE_NUM];
} MI_ISP_AWB_SPECIALCASE_PARAM_t;

typedef struct MI_ISP_AWB_SPECIALCASE_INFO_s
{
    MI_U32 u4Group1Cnt[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U32 u4Group1CntRatio[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U32 u4Group2Cnt[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U32 u4Group2CntRatio[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U32 u4BvRatio[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U32 u4CaseRatio[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U16 u2CaseWeight[MI_ISP_AWB_SPECIAL_CASE_NUM][MI_ISP_AWB_CT_TBL_NUM];
    MI_U16 u2SpecialWeight[MI_ISP_AWB_CT_TBL_NUM];
    MI_U16 u2SpecialRgain[MI_ISP_AWB_SPECIAL_CASE_NUM];
    MI_U16 u2SpecialBgain[MI_ISP_AWB_SPECIAL_CASE_NUM];
} MI_ISP_AWB_SPECIALCASE_INFO_t;
