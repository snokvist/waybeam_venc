...
typedef enum
{
    MI_VPE_LDC_WORKMODE_LDC = 0x00,
    MI_VPE_LDC_WORKMODE_DIS_GYRO = 0x01,
} MI_VPE_LdcWorkMode_e;

typedef enum
{
    MI_VPE_LDC_MAPINFOTYPE_DISPMAP,
    MI_VPE_LDC_MAPINFOTYPE_SENSORCALIB,
} MI_VPE_LdcMapInfoType_e;

typedef enum
{
    MI_VPE_LDCLENSTYPE_FIX,
    MI_VPE_LDCLENSTYPE_ZOOM,
} MI_VPE_LdcLensType_e;

typedef struct MI_VPE_LdcDisplacementMapInfo_s
{
    void *pXmapAddr;
    void *pYmapAddr;
    MI_U32 u32XmapSize;
    MI_U32 u32YmapSize;
} MI_VPE_LdcDisplacementMapInfo_t;

typedef struct MI_VPE_LdcSensorCalibInfo_s
{
    void *pCalibPolyBinAddr;
    MI_U32 u32CalibPolyBinSize;
} MI_VPE_LdcSensorCalibInfo_t;

typedef struct MI_VPE_LdcInitPara_s
{
    MI_VPE_LdcWorkMode_e eMode;
    ...
    MI_VPE_LdcMapInfoType_e eInfoType;
    union
    {
        MI_VPE_LdcDisplacementMapInfo_t stDispMapInfo;
        MI_VPE_LdcSensorCalibInfo_t stCalibInfo;
    };
}MI_VPE_LdcInitPara_t;
...
typedef struct MI_VPE_ChannelAttr_s
{
    ...
    MI_VPE_LdcInitPara_t tLdcInitPara;
...
typedef struct MI_VPE_LdcParam_s
{
    MI_BOOL bBypass;
    MI_BOOL bUseProjection3x3Matrix;
    MI_S32 as32Projection3x3Matrix[LDC_MAXTRIX_NUM];
